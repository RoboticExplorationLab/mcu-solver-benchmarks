...
size_P_1 = osqp_mem_P_1(3, [1,2,4,7]);
size_P_2 = osqp_mem_P_2(3, [1,2,4,7]);
size_P_3 = osqp_mem_P_3(3, [1,2,4,7]);
...
size_P_1 = tinympc_mem_P_1(3, [1,2,4,7,10,11]);
size_P_2 = tinympc_mem_P_2(3, [1,2,4,7,10,11]);
size_P_3 = tinympc_mem_P_3(3, [1,2,4,7,10,11]);
...
line1 = plot(xs_tinympc_index,avg_mem_tinympc,'Marker','.','MarkerSize',25,'color', [0, 0, 0.6], 'LineWidth', 5);
hold on 
...
line2 = plot(xs_osqp_index,avg_mem_osqp,'Marker','.','MarkerSize',25,'color', [1, 0, 0], 'LineWidth', 5);
hold on
yline(128, '--', 'Label', 'RAM Threshold [128 kB]','FontSize', 18, 'LineWidth', 5);
